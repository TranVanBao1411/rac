...
require(game.ReplicatedStorage:WaitForChild("Notification")).new(
    " <Color=Red>Tysm For Use Wait 5S To Loading<Color=/> "
):Display()
wait(3)
...
getgenv().ToTargets = function(p)
    ...
    local Window = OrionLib:MakeWindow({Name = "Anbatukam Hub", HidePremium = false, IntroText = "Anbatukam Hub | Community", Icon = "15034250264"})
...
local PlayerSex = Window:MakeTab({
	Name = "Players & Stats",
...
spawn(function()
    while wait() do
        pcall(function()
            if _G.FastMode == "Slow" then
                DelayFast = "1"
            elseif _G.FastMode == "Normal" then
                DelayFast = "0.5"
            elseif _G.FastMode == "Fast" then
                DelayFast = "0.3"
            end
        end)
    end
...
SettingTab:AddToggle({
	Name = "Auto Use Race ( V3 And Awakened Race )",
	Default = false,
	Flag = "Turn On V4",
	Save = true,
	Callback = function(Value)
...
MainTab:AddToggle({
	Name = "Auto Farm Lv Mastery Fruit",
	Default = false,
	Flag = "Mastery Fruit",
	Save = true,
	Callback = function(Value)
                                        ...
                                        if string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, NameMon) then
                                            ...
                                            repeat task.wait()
                                                if v.Humanoid.Health <= HealthMs then
                                                    ...
                                                    TP1(v.HumanoidRootPart.CFrame * CFrame.new(5,5,10))
                                                    TP1(v.HumanoidRootPart.CFrame * CFrame.new(PosX,PosY,PosZ))
                                                    v.HumanoidRootPart.CanCollide = false
                                    ...
                                    repeat task.wait()
                                        if string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, NameMon) then
                                            ...
                                            if v.Humanoid.Health <= HealthMin then
                                                ...
                                                wait()
                                                TP1(v.HumanoidRootPart.CFrame * CFrame.new(0,10,10))
                                                wait()
                                                TP1(v.HumanoidRootPart.CFrame * CFrame.new(0,10,5))
                                                v.Humanoid.WalkSpeed = 0
                                                v.HumanoidRootPart.CanCollide = false
...
MainTab:AddParagraph("Chest Farm","")

MainTab:AddToggle({
	Name = "Farm Chest ( Teleport )",
	Default = false,
	Callback = function(Value)
		AutoFarmChest = Value
			...
			for i,v in pairs(game:GetService("Workspace"):GetChildren()) do
				if v.Name:find("Chest") then
					if game:GetService("Workspace"):FindFirstChild(v.Name) then
						if (v.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 123456789 then
							repeat wait()
								if game:GetService("Workspace"):FindFirstChild(v.Name) then
									topos(v.CFrame)
								end
...
MainTab:AddToggle({
	Name = "Farm Chest ( Instant Teleport )",
	Default = false,
	Callback = function(Value)
    ...
    while wait() do 
        pcall(function()
            if _G.ChestBypass then
                for i,v in pairs(game:GetService("Workspace"):GetChildren()) do 
                    if v.Name:find("Chest") or v.Name:find("Chest1") or v.Name:find("Chest2") or v.Name:find("Chest3") then 
                        if game:GetService("Workspace"):FindFirstChild(v.Name) then
                            if (v.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 5000000000 then
                                repeat wait()
                                    if game:GetService("Workspace"):FindFirstChild(v.Name) then                      
...
local gg = ItemTab:AddLabel('Go To Other World To Have More Function About That World')
if World3 then
    local FM = ItemTab:AddLabel('Nothing')
    task.spawn(function()
            while task.wait() do
                pcall(function()
...
ItemTab:AddToggle({
    ...
    elseif World3 then
    ItemTab:AddParagraph("Mystic Island","Mystic")
    spawn(function()
        pcall(function()
            while wait() do
					...
					for i,v in pairs(game:GetService("Workspace").Map.MysticIsland:GetChildren()) do
						if v:IsA("MeshPart")then
                            if v.Material ==  Enum.Material.Neon then
                                topos(v.CFrame * Cframe.new(1,5,1))
                                wait()
                                topos(v.CFrame * Cframe.new(1,4,1))
                                wait()
                                topos(v.CFrame * Cframe.new(1,3,1))
                                wait()
                                topos(v.CFrame * Cframe.new(1,2,1))
                                wait()
                                topos(v.CFrame * Cframe.new(1,1,1))
                                wait()
                                topos(v.CFrame)
                            end
                        end
...
if World2 then
ItemTab:AddParagraph("Upgrade Race","")
ItemTab:AddToggle({
                            ...
                            if v.Name == "Cake Prince [Lv. 2300] [Raid Boss]" then
                                if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                                    repeat task.wait()
                                        ...
                                        topos(v.HumanoidRootPart.CFrame * CFrame.new(PosX,PosY,PosZ))
                                        wait()
                                        topos(v.HumanoidRootPart.CFrame * CFrame.new(10,20,30))
                                        game:GetService("VirtualUser"):CaptureController()
                                        game:GetService("VirtualUser"):Button1Down(Vector2.new(1280,672))
                                ...
                                if game:GetService("Workspace").Enemies:FindFirstChild("Cookie Crafter [Lv. 2200]") or game:GetService("Workspace").Enemies:FindFirstChild("Cake Guard [Lv. 2225]") or game:GetService("Workspace").Enemies:FindFirstChild("Baking Staff [Lv. 2250]") or game:GetService("Workspace").Enemies:FindFirstChild("Head Baker [Lv. 2275]") then
                                    for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                                        if v.Name == "Cookie Crafter [Lv. 2200]" or v.Name == "Cake Guard [Lv. 2225]" or v.Name == "Baking Staff [Lv. 2250]" or v.Name == "Head Baker [Lv. 2275]" then
                                            if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                                                repeat task.wait()
                                                    if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == false and _G.AutoDoughtBoss and World3 then
                                                        local args = {
                                                            [1] = "AbandonQuest"
                                                        }
...
ItemTab:AddParagraph("Auto Get Melee","Get Melee")
ItemTab:AddToggle({
				...
				if game.Players.LocalPlayer.Character:FindFirstChild("Superhuman") or game.Players.LocalPlayer.Backpack:FindFirstChild("Superhuman") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Black Leg") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Black Leg") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Death Step") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Death Step") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Fishman Karate") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Fishman Karate") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Sharkman Karate") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Sharkman Karate") or game.Players.LocalPlayer.Backpack:FindFirstChild("Electro") or game.Players.LocalPlayer.Character:FindFirstChild("Electro") or game.Players.LocalPlayer.Backpack:FindFirstChild("Electric Claw") or game.Players.LocalPlayer.Character:FindFirstChild("Electric Claw") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Dragon Claw") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Dragon Claw") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Dragon Talon") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Dragon Talon") or game.Players.LocalPlayer.Character:FindFirstChild("Godhuman") or game.Players.LocalPlayer.Backpack:FindFirstChild("Godhuman") then
					if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuySuperhuman",true) == 1 then
						...
						game.StarterGui:SetCore("SendNotification", {
							...
							Icon = "http://www.roblox.com/asset/?id=14878105537",
							Duration = 2.5
						})
					end
...
ItemTab:AddParagraph("Farm Meterials","")
ItemTab:AddToggle({
                    ...
                    if game:GetService("Workspace").Enemies:FindFirstChild("Mythological Pirate [Lv. 1850]") then
                        for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                            if v.Name == "Mythological Pirate [Lv. 1850]" then
                                if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                                    repeat task.wait()
                                        if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == false and MiniHee and World3 then
                                            local args = {
                                                [1] = "AbandonQuest"
                                            }
                    ...
                    if game:GetService("Workspace").Enemies:FindFirstChild("Chocolate Bar Battler [Lv. 2325]") then
                        for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                            if v.Name == "Chocolate Bar Battler [Lv. 2325]" then
                                if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                                    repeat task.wait()
                                        if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == false and Cocoafarm and World3 then
                                            local args = {
                                                [1] = "AbandonQuest"
                                            }
                    ...
                    if game:GetService("Workspace").Enemies:FindFirstChild("Dragon Crew Warrior [Lv. 1575]") then
                        for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                            if v.Name == "Dragon Crew Warrior [Lv. 1575]" then
                                if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                                    repeat task.wait()
                                        if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == false and Dragon_Scale and World3 then
                                            local args = {
                                                [1] = "AbandonQuest"
                                            }
                    ...
                    if game:GetService("Workspace").Enemies:FindFirstChild("Fishman Captain [Lv. 1800]") then
                        for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                            if v.Name == "Fishman Captain [Lv. 1800]" then
                                if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                                    repeat task.wait()
                                        if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == false and Fish and World3 then
                                            local args = {
                                                [1] = "AbandonQuest"
                                            }
...
ItemTab:AddParagraph("Sea Events","")
ItemTab:AddToggle({
	Name = "Kill Sea Beast",
	Default = false,
	Flag = "Kill Sea Beast",
                    ...
                    function()
                        for i, v in pairs(game:GetService("Workspace").SeaBeasts:GetChildren()) do
                            if v:FindFirstChild("HumanoidRootPart") then
                                ...
                                wait()
                                TP1(v.HumanoidRootPart.CFrame * CFrame.new(100, 450, 10))
                                wait()
                                TP1(v.HumanoidRootPart.CFrame * CFrame.new(95, 450, 45))
                                game:GetService("VirtualUser"):CaptureController()
                                game:GetService("VirtualUser"):Button1Down(Vector2.new(1280, 672))
                                for i, v in pairs(game.Players.LocalPlayer.Backpack:GetChildren()) do
                                    if v:IsA("Tool") then
...
if World3 then
ItemTab:AddParagraph("Dark Dagger","")
ItemTab:AddToggle({
	Name = "Kill Rip Indra Boss",
	Default = false,
	Callback = function(Value)
...
ItemTab:AddParagraph("Cursed Dual Katana","Cursed Dual Katana")
...
ItemTab:AddToggle({
	Name = "Auto Quest Cursed Dual Katana",
	Default = false,
	Flag = "CursedKatana",
	Save = true,
	Callback = function(Value)
 ...
 ItemTab:AddParagraph("Soul Guitar","Must Full Moon")
...
if World2 or World3 then
ItemTab:AddParagraph("Haki Color","")
...
local SeraphFrame =
    debug.getupvalues(require(game:GetService("Players").LocalPlayer.PlayerScripts:WaitForChild("CombatFramework")))[2]
local VirtualUser = game:GetService("VirtualUser")
local RigControllerR =
    debug.getupvalues(require(game:GetService("Players").LocalPlayer.PlayerScripts.CombatFramework.RigController))[2]
    ...
    for i = 1, #Enemies do
        ...
        if
            Human and Human.RootPart and Human.Health > 0 and
                game.Players.LocalPlayer:DistanceFromCharacter(Human.RootPart.Position) < Size + 15
         then
...
task.spawn(
    function()
        while wait() do
            if _G.FastAttack or getgenv().SuperFast then
                if SeraphFrame.activeController then
                    -- if v.Humanoid.Health > 0 then
                    SeraphFrame.activeController.timeToNextAttack =
                        -math.huge * -math.huge * -math.huge * -math.huge * -math.huge * -math.huge * -math.huge * -math.huge
                    SeraphFrame.activeController.focusStart =
                        math.huge * math.huge * math.huge * math.huge * math.huge * math.huge * math.huge * math.huge
                    SeraphFrame.activeController.hitboxMagnitude =
                        math.huge * math.huge * math.huge * math.huge * math.huge * math.huge * math.huge * math.huge
                    SeraphFrame.activeController.humanoid.AutoRotate = true
                    SeraphFrame.activeController.increment =
                        math.huge * math.huge * math.huge * math.huge * math.huge * math.huge * math.huge * math.huge
                -- end
                end
            end
    ...
    function()
        while wait() do
            if _G.FastAttack then
                if b - tick() > 0.75 then
                    wait(DelayFast)
                    SeraphFrame.activeController = true
                    b = tick()
                end
                pcall(
                    function()
                            ...
                            if v.Humanoid.Health > 0 then
                                if
                                    (v.HumanoidRootPart.Position -
                                        game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 40
                                 then
                                    oneforall()
                                    oneforalltwo()
                                    wait(DelayFast)
                    ...
                    pcall(
                        function()
                            require(game:GetService("ReplicatedStorage").CombatFramework.RigLib).wrapAttackAnimationAsync = function(
                                ...
                                a5)
                                local GetBladeHits =
                                    require(game:GetService("ReplicatedStorage").CombatFramework.RigLib).getBladeHits(
                                    a2,
                                    a3,
                                    a4
                                )
...
MainTab:AddParagraph("Boss Farm","")
...
if World3 then
ItemTab:AddParagraph("Raid Pirates","")
...
if World3 then
ItemTab:AddParagraph("Bone Farm","")

BoneCheck = ItemTab:AddLabel("Your Bone : Third World ")
...
local BoneFarm = ItemTab:AddToggle({
	Name = "Auto Farm Bone",
	Default = false,
	Flag = "Farm Bone",
	Save = true,
            ...
            while wait() do
                if _G.Auto_Bone and World3 then
                    pcall(function()
                        spawn(function()
                            while wait() do
                        if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == false and _G.Auto_Bone and World3 then
                            local args = {
                                [1] = "AbandonQuest"
                            }
                                ...
                                if v.Name == "Reborn Skeleton [Lv. 1975]" or v.Name == "Living Zombie [Lv. 2000]" or v.Name == "Demonic Soul [Lv. 2025]" or v.Name == "Posessed Mummy [Lv. 2050]" then
                                   if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                                       repeat task.wait()
                                            ...
                                            topos(v.HumanoidRootPart.CFrame * CFrame.new(PosX,PosY,PosZ))
                                            wait()
                                            topos(v.HumanoidRootPart.CFrame * CFrame.new(10,10,10))
                                            wait()
                                            topos(v.HumanoidRootPart.CFrame * CFrame.new(0,10,10))
                                            wait()
                                            topos(v.HumanoidRootPart.CFrame * CFrame.new(5,20,10))
                                            game:GetService("VirtualUser"):CaptureController()
                                            game:GetService("VirtualUser"):Button1Down(Vector2.new(1280,672))
...
MainTab:AddParagraph("Auto Travel Sea","")
end
if World1 then
MainTab:AddToggle({
	Name = "Quest Dressrosa ( Sea 2 )",
	Default = false,
	Callback = function(Value)
...
MainTab:AddToggle({
    ...
    PlayerSex:AddParagraph("Players","Kill Players")
...
local SelectedPly = PlayerSex:AddDropdown({
	Name = "Select Players",
	Default = "",
	Options = Playerslist,
	Callback = function(Value)
	...
	Callback = function(Value)
	    ...
	    pcall(function()
            if _G.TeleportPly then
                repeat topos(game:GetService("Players")[_G.SelectPly].Character.HumanoidRootPart.CFrame * Cframe.new(0,1,3)) wait() until _G.TeleportPly == false
            end
                        ...
                        if game.Players:FindFirstChild(_G.SelectPly) then
                            if game.Players:FindFirstChild(_G.SelectPly).Character.Humanoid.Health > 0 then
                                repeat task.wait()
                                    ...
                                    wait()
                                    topos(game.Players:FindFirstChild(_G.SelectPly).Character.HumanoidRootPart.CFrame * CFrame.new(0,15,5))
                                    wait()
                                    topos(game.Players:FindFirstChild(_G.SelectPly).Character.HumanoidRootPart.CFrame * CFrame.new(0,-10,5))
                                    spawn(function()
                                        pcall(function()
...
spawn(function()
    while task.wait() do
        pcall(function()
            if _G.BringDelta then
                CheckLevel()
                for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                    if _G.Auto_Farm_Level and _G.BringDelta and v.Name == MonFarm and (Mon == "Factory Staff [Lv. 800]" or Mon == "Monkey [Lv. 14]" or Mon == "Dragon Crew Warrior [Lv. 1575]" or Mon == "Dragon Crew Archer [Lv. 1600]") and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 and (v.HumanoidRootPart.Position - game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= _G.BringMode then
                        v.HumanoidRootPart.Size = Vector3.new(50,50,50)
                        v.HumanoidRootPart.CFrame = FarmPos
                        v.Humanoid:ChangeState(14)
                        v.HumanoidRootPart.CanCollide = false
                        ...
                        sethiddenproperty(game:GetService("Players").LocalPlayer,"SimulationRadius",math.huge)
                    elseif _G.Auto_Farm_Level and _G.BringDelta and v.Name == MonFarm and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 and (v.HumanoidRootPart.Position - game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= _G.BringMode then
                        v.HumanoidRootPart.Size = Vector3.new(50,50,50)
                        v.HumanoidRootPart.CFrame = FarmPos
                        v.Humanoid:ChangeState(14)
                        v.HumanoidRootPart.CanCollide = false
...
task.spawn(function()
    ...
    pcall(function()
      ...
      for i,v in pairs(game.Workspace.Enemies:GetChildren()) do
      if not string.find(v.Name,"Boss") and (v.HumanoidRootPart.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 1000 then
                ...
                if _G.BringMonster then
                    ...
                    for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                        ...
                        if _G.Farmfast and StardMag then
                            if (v.Name == "Shanda [Lv. 475]") and (v.HumanoidRootPart.Position - FastMon.Position).Magnitude <= _G.BringMode and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                                v.HumanoidRootPart.Size = Vector3.new(50,50,50)
                        ...
                        if _G.AutoCandy and StartMagnetCandy then
                            if (v.HumanoidRootPart.Position - PosMonCandy.Position).Magnitude <= _G.BringMode and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                                v.HumanoidRootPart.Size = Vector3.new(50,50,50)
                                v.Humanoid:ChangeState(14)
                                v.HumanoidRootPart.CanCollide = false
                                v.Head.CanCollide = false
    ...
    SettingTab:AddToggle({
        Name = "Destroy All Notify",
        Default = false,
        Callback = function(mageni)
            mage = mageni
        end
    })
spawn(function()
        ...
        if mage then
            pcall(function()
                ...
                for i, v in pairs(game.Workspace["_WorldOrigin"]:GetChildren()) do
                    if
                        v.Name == "CurvedRing" or v.Name == "SlashHit" or v.Name == "DamageCounter" or v.Name == "SwordSlash" or
                            v.Name == "SlashTail" or
                            v.Name == "Sounds"
                     then
                        v:Destroy()
...
TeleTab:AddParagraph("Teleport World","Travel Sea")

TeleTab:AddButton({
	Name = "Travel Main (Sea 1)",
	Callback = function()
...
TeleTab:AddParagraph("Topos","Teleport")
...
TeleTab:AddParagraph("Bypass Teleport","Bypass")
...
--// Function Auto Click
    ...
    RaidTab:AddParagraph("Raid","Raid Function")
RaidTab:AddDropdown({
	Name = "Select Chips",
	Default = "",
	Options = Raidslist,
...
RaidTab:AddToggle({
    ...
    RaidTab:AddParagraph("Fruits","Fruits Function")
RaidTab:AddButton({
	Name = "Random Fruits 1 Times",
	Callback = function()
...
spawn(
    ...
    if World1 or World2 then
      V4Tab:AddLabel("Need Unlock Sea 3")
    end
    
    if World3 then
    V4Tab:AddParagraph("Mystic Island","Mystic")
      V4Tab:AddButton({
        Name = "Teleport Top GreatTree",
        Callback = function()
    ...
    V4Tab:AddParagraph("Trial Race","Mystic Island")
    ...
    spawn(
        ...
        V4Tab:AddToggle({
            Name = "Kill Kids After Trials ( Must Done Trials )",
            Default = false,
            Callback = function(Value)
                                     ...
                                     then
                                        if v.Humanoid.Health > 0 then
                                            repeat
                                                ...
                                                topos(v.HumanoidRootPart.CFrame * CFrame.new(0, 5, 0))
                                                wait()
                                                topos(v.HumanoidRootPart.CFrame * CFrame.new(0, 5, 5))
                                                v.HumanoidRootPart.CanCollide = false
                                                v.HumanoidRootPart.Size = Vector3.new(60, 60, 60)
                                                Click()
                                                for i, v in pairs(game.Players.LocalPlayer.Backpack:GetChildren()) do
...
SHTab:AddButton({
	Name = "Auto Buy Selected Haki",
	Callback = function()
        if _G.BuyHaki == "Geppo" then
            game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyHaki","Geppo")
        elseif _G.BuyHaki == "Buso" then
            game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyHaki","Buso")
        elseif _G.Buyhaki == "Soru" then
            game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyHaki","Soru")
        elseif _G.BuyHaki == "Ken ( Observation )" then
            game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("KenTalk","Buy")
        end
    end
})
...
PlayerSex:AddParagraph("Stats","Up Stats")
...
MiscTab:AddToggle({
    ...
    MiscTab:AddToggle({
        Name = "Walk On Water ( Change Size )",
        Default = true,
        Callback = function(Value)
            _G.WalkWater = Value
        end
        ...
        spawn(function()
            ...
            MiscTab:AddButton({
                Name = "Water Walk ( Like W-Azure But Not Have Part )",
                Callback = function()
                    local partSize = Vector3.new(2048, 50, 2048)
                    local targetSize = Vector3.new(50000, 50, 50000)
                    local numPartsX = math.ceil(targetSize.X / partSize.X)
                    local numPartsZ = math.ceil(targetSize.Z / partSize.Z)
                    local fold = Instance.new("Folder", game.Workspace.Map)
                    ...
                    local settings = {
                        ...
                        for x = 1, numPartsX do
                            for z = 1, numPartsZ do
                                local uwu1 = Instance.new("Part", settings.Parent)
                                uwu1.Name = "Water Walking Copy W-Azure"
                                uwu1.Position = Vector3.new((x - 1) * partSize.X, -28, (z - 1) * partSize.Z)
                                uwu1.Anchored = true
                                uwu1.Size = Vector3.new(partSize.X, partSize.Y, partSize.Z)
                                uwu1.Transparency = settings.Transparency
                                uwu1.Reflectance = settings.Reflectance
                                uwu1.Material = settings.Material
                                local uwu2 = Instance.new("Part", settings.Parent)
                                uwu2.Name = "Water Walking Copy W-Azure"
                                uwu2.Position = Vector3.new((x - 1) * partSize.X, -28.889999389648438, -(z - 1) * partSize.Z)
                                uwu2.Anchored = true
                                uwu2.Size = Vector3.new(partSize.X, partSize.Y, partSize.Z)
                                uwu2.Transparency = settings.Transparency
                                uwu2.Reflectance = settings.Reflectance
                                uwu2.Material= settings.Material
                                local uwu3 = Instance.new("Part", settings.Parent)
                                uwu3.Name = "Water Walking Copy W-Azure"
                                uwu3.Position = Vector3.new(-(x - 1) * partSize.X, -28.889999389648438, (z - 1) * partSize.Z)
                                uwu3.Anchored = true
                                uwu3.Size = Vector3.new(partSize.X, partSize.Y, partSize.Z)
                                uwu3.Transparency = settings.Transparency
                                uwu3.Reflectance = settings.Reflectance
                                uwu3.Material= settings.Material
                                local uwu4 = Instance.new("Part", settings.Parent)
                                uwu4.Name = "Water Walking Copy W-Azure"
                                uwu4.Position = Vector3.new(-(x - 1) * partSize.X, -28.889999389648438, -(z - 1) * partSize.Z)
                                uwu4.Anchored = true
                                uwu4.Size = Vector3.new(partSize.X, partSize.Y, partSize.Z)
                                uwu4.Transparency = settings.Transparency
                                uwu4.Reflectance = settings.Reflectance
                                uwu4.Material= settings.Material
                            end
                        end
...
MiscTab:AddToggle({
	Name = "Infinity Abilities",
	Default = false,
	Callback = function(Vadsd)
		getgenv().INFABI = Vadsd
	end
})
spawn(function()
    while wait() do
        if getgenv().INFABI then
        pcall(function()
            InfAb()
            end)
        end
...
MiscTab:AddToggle({
    ...
    MiscTab:AddToggle({
        Name = "Infinity Obversation Range",
        Default = getgenv().InfGeppo,
        Callback = function(nvc)
            getgenv().InfiniteObRange = nvc
        end
    })
    ...
    -- White If Close Roblox
    local InputService = game:GetService("UserInputService")
    if getgenv().C["White If Open Other Tab"] then
