...
local L_3_ = {
   function()
      ...
      local L_9_, L_10_, L_11_, L_12_, L_13_, L_14_ = game:GetService'Lighting', game:GetService'RunService', game:GetService'Players'.LocalPlayer, game:GetService'UserInputService', game:GetService'TweenService', game:GetService'Workspace'.CurrentCamera
      local L_15_, L_16_ = L_11_:GetMouse(), L_5_
      local L_17_, L_18_, L_19_, L_20_ = L_6_(L_16_.Creator), L_6_(L_16_.Elements), L_6_(L_16_.Acrylic), L_16_.Components
      local L_21_, L_22_, L_23_ = L_6_(L_20_.Notification), L_17_.New, protectgui or (syn and syn.protect_gui) or function()
   end
   local L_24_ = L_22_('ScreenGui', {
      Parent = L_10_:IsStudio() and L_11_.PlayerGui or game:GetService'CoreGui'
   })
   L_23_(L_24_)
   L_21_:Init(L_24_)
   local L_25_ = {
      ...
      OpenFrames = {},
      Options = {},
      Themes = L_6_(L_16_.Themes).Names,
      Window = nil,
      WindowFrame = nil,
      Unloaded = false,
      Theme = 'Dark',
   ...
   function L_25_.Round(L_34_arg0, L_35_arg1, L_36_arg2)
      ...
      return L_35_arg1:find'%.' and tonumber(L_35_arg1:sub(1, L_35_arg1:find'%.' + L_36_arg2)) or L_35_arg1
   end
   local L_26_ = L_6_(L_16_.Icons).assets
...
return L_21_:New(L_57_arg1)
end
if getgenv then
getgenv().Fluent = L_25_
end
return L_25_
end,
function()
local L_58_, L_59_, L_60_, L_61_, L_62_ = L_2_(2)
local L_63_ = {
...
function()
local L_77_, L_78_, L_79_, L_80_, L_81_ = L_2_(3)
...
function()
local L_122_, L_123_, L_124_, L_125_, L_126_ = L_2_(4)
...
function()
local L_133_, L_134_, L_135_, L_136_, L_137_ = L_2_(5)
...
function()
local L_142_, L_143_, L_144_, L_145_, L_146_ = L_2_(6)
...
[8] = function()
local L_159_, L_160_, L_161_, L_162_, L_163_ = L_2_(8)
return {
...
[9] = function()
local L_164_, L_165_, L_166_, L_167_, L_168_ = L_2_(9)
...
[10] = function()
local L_180_, L_181_, L_182_, L_183_, L_184_ = L_2_(10)
...
[11] = function()
local L_213_, L_214_, L_215_, L_216_, L_217_ = L_2_(11)
...
[12] = function()
local L_236_, L_237_, L_238_, L_239_, L_240_ = L_2_(12)
...
[13] = function()
local L_259_, L_260_, L_261_, L_262_, L_263_ = L_2_(13)
...
[14] = function()
local L_270_, L_271_, L_272_, L_273_, L_274_ = L_2_(14)
...
[15] = function()
local L_309_, L_310_, L_311_, L_312_, L_313_ = L_2_(15)
...
[16] = function()
local L_329_, L_330_, L_331_, L_332_, L_333_ = L_2_(16)
...
[17] = function()
local L_352_, L_353_, L_354_, L_355_, L_356_ = L_2_(17)
...
if type(L_370_.MinimizeKeybind) == 'table' and L_370_.MinimizeKeybind.Type == 'Keybind' and not L_357_:GetFocusedTextBox() then
if L_413_arg0.KeyCode.Name == L_370_.MinimizeKeybind.Value then
L_371_:Minimize()
end
elseif L_413_arg0.KeyCode == L_370_.MinimizeKey and not L_357_:GetFocusedTextBox() then
L_371_:Minimize()
end
end)
...
L_370_:Notify{
Title = 'Interface',
Content = 'Press ' .. L_415_ .. ' to toggle the inteface.',
Duration = 6
}
end
end
...
[18] = function()
local L_427_, L_428_, L_429_, L_430_, L_431_ = L_2_(18)
...
[19] = function()
local L_476_, L_477_, L_478_, L_479_, L_480_ = L_2_(19)
local L_481_ = {}
...
[20] = function()
local L_484_, L_485_, L_486_, L_487_, L_488_ = L_2_(20)
...
[21] = function()
local L_498_, L_499_, L_500_, L_501_, L_502_ = L_2_(21)
...
local L_527_, L_528_, L_529_ = Color3.toHSV(L_526_arg1)
L_519_.Hue = L_527_
L_519_.Sat = L_528_
L_519_.Vib = L_529_
end
...
L_531_, L_532_, L_533_ = Color3.toHSV(L_566_)
end
end
L_557_()
end)
...
L_531_, L_532_, L_533_ = Color3.toHSV(L_570_)
end
end
end
L_557_()
...
L_531_, L_532_, L_533_ = Color3.toHSV(L_574_)
end
end
end
L_557_()
...
L_531_, L_532_, L_533_ = Color3.toHSV(L_578_)
end
end
end
L_557_()
...
[22] = function()
local L_607_, L_608_, L_609_, L_610_, L_611_ = L_2_(22)
...
Opened = false,
Type = 'Dropdown',
Callback = L_624_arg2.Callback or function()
end
...
[23] = function()
local L_698_, L_699_, L_700_, L_701_, L_702_ = L_2_(23)
...
[24] = function()
local L_724_, L_725_, L_726_, L_727_, L_728_ = L_2_(24)
...
if L_739_.Value == 'None' then
return false
end
local L_747_ = L_739_.Value
if L_747_ == 'MouseLeft' or L_747_ == 'MouseRight' then
return L_747_ == 'MouseLeft' and L_729_:IsMouseButtonPressed(Enum.UserInputType.MouseButton1) or L_747_ == 'MouseRight' and L_729_:IsMouseButtonPressed(Enum.UserInputType.MouseButton2)
else
return L_729_:IsKeyDown(Enum.KeyCode[L_739_.Value])
end
else
...
elseif L_759_arg0.UserInputType == Enum.UserInputType.MouseButton1 then
L_760_ = 'MouseLeft'
...
if L_762_arg0.KeyCode.Name == L_760_ or L_760_ == 'MouseLeft' and L_762_arg0.UserInputType == Enum.UserInputType.MouseButton1 or L_760_ == 'MouseRight' and L_762_arg0.UserInputType == Enum.UserInputType.MouseButton2 then
L_740_ = false
L_742_.Text = L_760_
L_739_.Value = L_760_
L_738_:SafeCallback(L_739_.ChangedCallback, L_762_arg0.KeyCode or L_762_arg0.UserInputType)
L_738_:SafeCallback(L_739_.Changed, L_762_arg0.KeyCode or L_762_arg0.UserInputType)
L_758_:Disconnect()
L_761_:Disconnect()
end
end)
...
if not L_740_ and not L_729_:GetFocusedTextBox() then
if L_739_.Mode == 'Toggle' then
local L_764_ = L_739_.Value
if L_764_ == 'MouseLeft' or L_764_ == 'MouseRight' then
if L_764_ == 'MouseLeft' and L_763_arg0.UserInputType == Enum.UserInputType.MouseButton1 or L_764_ == 'MouseRight' and L_763_arg0.UserInputType == Enum.UserInputType.MouseButton2 then
L_739_.Toggled = not L_739_.Toggled
L_739_:DoClick()
end
elseif L_763_arg0.UserInputType == Enum.UserInputType.Keyboard then
if L_763_arg0.KeyCode.Name == L_764_ then
L_739_.Toggled = not L_739_.Toggled
L_739_:DoClick()
end
end
...
[25] = function()
local L_765_, L_766_, L_767_, L_768_, L_769_ = L_2_(25)
...
[26] = function()
local L_778_, L_779_, L_780_, L_781_, L_782_ = L_2_(26)
...
[27] = function()
local L_811_, L_812_, L_813_, L_814_, L_815_ = L_2_(27)
...
[28] = function()
local L_837_, L_838_, L_839_, L_840_, L_841_ = L_2_(28)
return {
...
[30] = function()
local L_842_, L_843_, L_844_, L_845_, L_846_ = L_2_(30)
local L_847_ = {
...
[31] = function()
local L_848_, L_849_, L_850_, L_851_, L_852_ = L_2_(31)
...
[32] = function()
local L_867_, L_868_, L_869_, L_870_, L_871_ = L_2_(32)
return function()
...
[33] = function()
local L_879_, L_880_, L_881_, L_882_, L_883_ = L_2_(33)
...
[34] = function()
local L_912_, L_913_, L_914_, L_915_, L_916_ = L_2_(34)
return function()
...
[35] = function()
local L_928_, L_929_, L_930_, L_931_, L_932_ = L_2_(35)
local L_933_ = {}
...
[36] = function()
local L_936_, L_937_, L_938_, L_939_, L_940_ = L_2_(36)
return function()
...
[37] = function()
local L_944_, L_945_, L_946_, L_947_, L_948_ = L_2_(37)
local L_949_ = {}
...
[38] = function()
local L_960_, L_961_, L_962_, L_963_, L_964_ = L_2_(38)
return function()
...
[39] = function()
local L_976_, L_977_, L_978_, L_979_, L_980_ = L_2_(39)
local L_981_ = {}
...
[40] = function()
local L_997_, L_998_, L_999_, L_1000_, L_1001_ = L_2_(40)
return function()
...
[41] = function()
local L_1014_, L_1015_, L_1016_, L_1017_, L_1018_ = L_2_(41)
...
[42] = function()
local L_1031_, L_1032_, L_1033_, L_1034_, L_1035_ = L_2_(42)
return function()
...
[43] = function()
local L_1043_, L_1044_, L_1045_, L_1046_, L_1047_ = L_2_(43)
...
[44] = function()
local L_1081_, L_1082_, L_1083_, L_1084_, L_1085_ = L_2_(44)
return function()
...
[45] = function()
local L_1093_, L_1094_, L_1095_, L_1096_, L_1097_ = L_2_(45)
...
[46] = function()
local L_1101_, L_1102_, L_1103_, L_1104_, L_1105_ = L_2_(46)
return function()
...
[47] = function()
local L_1115_, L_1116_, L_1117_, L_1118_, L_1119_ = L_2_(47)
local L_1120_ = {
Names = {
'Dark',
'Darker',
...
[48] = function()
local L_1124_, L_1125_, L_1126_, L_1127_, L_1128_ = L_2_(48)
return {
Name = 'Amethyst',
...
[49] = function()
local L_1129_, L_1130_, L_1131_, L_1132_, L_1133_ = L_2_(49)
return {
Name = 'Aqua',
...
[52] = function()
local L_1144_, L_1145_, L_1146_, L_1147_, L_1148_ = L_2_(52)
return {
Name = 'Light',
...
[53] = function()
local L_1149_, L_1150_, L_1151_, L_1152_, L_1153_ = L_2_(53)
return {
Name = 'Rose',
...
do
local L_1154_, L_1155_, L_1156_, L_1157_, L_1158_, L_1159_, L_1160_, L_1161_, L_1162_, L_1163_, L_1164_, L_1165_, L_1166_, L_1167_, L_1168_, L_1169_ = task, setmetatable, error, newproxy, getmetatable, next, table, unpack, coroutine, script, type, require, pcall, getfenv, setfenv, rawget
local L_1170_, L_1171_, L_1172_, L_1173_, L_1174_, L_1175_, L_1176_, L_1177_, L_1178_, L_1179_, L_1180_ = L_1160_.insert, L_1160_.remove, L_1160_.freeze or function(L_1187_arg0)
return L_1187_arg0
end, L_1154_ and L_1154_.defer or function(L_1188_arg0, ...)
local L_1189_ = L_1162_.create(L_1188_arg0)
L_1162_.resume(L_1189_, ...)
return L_1189_
end, '0.0.0-venv', {}, {}, {}, {}, {}, {}
local L_1181_, L_1182_ = {
GetChildren = function(L_1190_arg0)
local L_1191_, L_1192_ = L_1180_[L_1190_arg0], {}
for L_1193_forvar0 in L_1159_, L_1191_ do
L_1170_(L_1192_, L_1193_forvar0)
end
return L_1192_
end,
FindFirstChild = function(L_1194_arg0, L_1195_arg1)
if not L_1195_arg1 then
L_1156_('Argument 1 missing or nil', 2)
end
for L_1196_forvar0 in L_1159_, L_1180_[L_1194_arg0] do
if L_1196_forvar0.Name == L_1195_arg1 then
return L_1196_forvar0
end
end
return
end,
GetFullName = function(L_1197_arg0)
local L_1198_, L_1199_ = L_1197_arg0.Name, L_1197_arg0.Parent
while L_1199_ do
L_1198_ = L_1199_.Name .. '.' .. L_1198_
L_1199_ = L_1199_.Parent
end
return 'VirtualEnv.' .. L_1198_
end
}, {}
for L_1200_forvar0, L_1201_forvar1 in L_1159_, L_1181_ do
L_1182_[L_1200_forvar0] = function(L_1202_arg0, ...)
if not L_1180_[L_1202_arg0] then
L_1156_("Expected ':' not '.' calling member function " .. L_1200_forvar0, 1)
end
return L_1201_forvar1(L_1202_arg0, ...)
end
end
local L_1183_ = function(L_1203_arg0, L_1204_arg1, L_1205_arg2)
local L_1206_, L_1207_, L_1208_, L_1209_, L_1210_ = L_1155_({}, {
__mode = 'k'
}), function(L_1212_arg0)
L_1156_(L_1212_arg0 .. ' is not a valid (virtual) member of ' .. L_1203_arg0 .. ' "' .. L_1204_arg1 .. '"', 1)
end, function(L_1213_arg0)
L_1156_('Unable to assign (virtual) property ' .. L_1213_arg0 .. '. Property is read only', 1)
end, (L_1157_(true))
local L_1211_ = L_1158_(L_1209_)
L_1211_.__index = function(L_1214_arg0, L_1215_arg1)
if L_1215_arg1 == 'ClassName' then
return L_1203_arg0
elseif L_1215_arg1 == 'Name' then
return L_1204_arg1
elseif L_1215_arg1 == 'Parent' then
return L_1205_arg2
elseif L_1203_arg0 == 'StringValue' and L_1215_arg1 == 'Value' then
return L_1210_
else
local L_1216_ = L_1182_[L_1215_arg1]
if L_1216_ then
return L_1216_
end
end
for L_1217_forvar0 in L_1159_, L_1206_ do
if L_1217_forvar0.Name == L_1215_arg1 then
return L_1217_forvar0
end
end
L_1207_(L_1215_arg1)
end
L_1211_.__newindex = function(L_1218_arg0, L_1219_arg1, L_1220_arg2)
if L_1219_arg1 == 'ClassName' then
L_1208_(L_1219_arg1)
elseif L_1219_arg1 == 'Name' then
L_1204_arg1 = L_1220_arg2
elseif L_1219_arg1 == 'Parent' then
if L_1220_arg2 == L_1209_ then
return
end
if L_1205_arg2 ~= nil then
L_1180_[L_1205_arg2][L_1209_] = nil
end
L_1205_arg2 = L_1220_arg2
if L_1220_arg2 ~= nil then
L_1180_[L_1220_arg2][L_1209_] = true
end
elseif L_1203_arg0 == 'StringValue' and L_1219_arg1 == 'Value' then
L_1210_ = L_1220_arg2
else
L_1207_(L_1219_arg1)
end
end
L_1211_.__tostring = function()
return L_1204_arg1
end
L_1180_[L_1209_] = L_1206_
if L_1205_arg2 ~= nil then
L_1180_[L_1205_arg2][L_1209_] = true
end
return L_1209_
end
local function L_1184_func(L_1221_arg0, L_1222_arg1)
local L_1223_, L_1224_, L_1225_, L_1226_ = L_1221_arg0[1], L_1221_arg0[2], L_1221_arg0[3], L_1221_arg0[4]
local L_1227_ = L_1171_(L_1225_, 1)
local L_1228_ = L_1183_(L_1224_, L_1227_, L_1222_arg1)
L_1175_[L_1223_] = L_1228_
if L_1225_ then
for L_1229_forvar0, L_1230_forvar1 in L_1159_, L_1225_ do
L_1228_[L_1229_forvar0] = L_1230_forvar1
end
end
if L_1226_ then
for L_1231_forvar0, L_1232_forvar1 in L_1159_, L_1226_ do
L_1184_func(L_1232_forvar1, L_1228_)
end
end
return L_1228_
end
local L_1185_ = {}
for L_1233_forvar0, L_1234_forvar1 in L_1159_, L_1_ do
L_1170_(L_1185_, L_1184_func(L_1234_forvar1))
end
for L_1235_forvar0, L_1236_forvar1 in L_1159_, L_3_ do
local L_1237_ = L_1175_[L_1235_forvar0]
L_1176_[L_1237_] = L_1236_forvar1
local L_1238_ = L_1237_.ClassName
if L_1238_ == 'LocalScript' or L_1238_ == 'Script' then
L_1170_(L_1178_, L_1237_)
end
end
local L_1186_ = function(L_1239_arg0)
local L_1240_, L_1241_ = L_1239_arg0.ClassName, L_1177_[L_1239_arg0]
if L_1241_ and L_1240_ == 'ModuleScript' then
return L_1161_(L_1241_)
end
local L_1242_ = L_1176_[L_1239_arg0]
if not L_1242_ then
return
end
if L_1240_ == 'LocalScript' or L_1240_ == 'Script' then
L_1242_()
return
else
local L_1243_ = {
...
L_1177_[L_1239_arg0] = L_1243_
return L_1161_(L_1243_)
end
end
function L_2_(L_1244_arg0)
local L_1245_ = L_1175_[L_1244_arg0]
local L_1246_ = L_1176_[L_1245_]
if not L_1246_ then
return
end
local L_1247_, L_1248_, L_1249_, L_1250_, L_1251_, L_1252_, L_1253_ = false, L_1172_{
Version = L_1174_,
Script = L_1163_,
Shared = L_1179_,
GetScript = function()
...
}, L_1245_, function(L_1256_arg0, ...)
if L_1180_[L_1256_arg0] and L_1256_arg0.ClassName == 'ModuleScript' and L_1176_[L_1256_arg0] then
return L_1186_(L_1256_arg0)
end
return L_1165_(L_1256_arg0, ...)
end
local L_1254_, L_1255_ = function(L_1257_arg0, ...)
if not L_1247_ then
L_1253_()
end
if L_1164_(L_1257_arg0) == 'number' and L_1257_arg0 >= 0 then
if L_1257_arg0 == 0 then
return L_1252_
else
L_1257_arg0 = L_1257_arg0 + 1
local L_1258_, L_1259_ = L_1166_(L_1167_, L_1257_arg0)
if L_1258_ and L_1259_ == L_1251_ then
return L_1252_
end
end
end
return L_1167_(L_1257_arg0, ...)
end, function(L_1260_arg0, L_1261_arg1, ...)
if not L_1247_ then
L_1253_()
end
if L_1164_(L_1260_arg0) == 'number' and L_1260_arg0 >= 0 then
if L_1260_arg0 == 0 then
return L_1168_(L_1252_, L_1261_arg1)
else
L_1260_arg0 = L_1260_arg0 + 1
local L_1262_, L_1263_ = L_1166_(L_1167_, L_1260_arg0)
if L_1262_ and L_1263_ == L_1251_ then
return L_1168_(L_1252_, L_1261_arg1)
end
end
end
return L_1168_(L_1260_arg0, L_1261_arg1, ...)
end
function L_1253_()
L_1251_ = L_1167_(0)
local L_1264_ = {
...
L_1252_ = L_1155_({}, {
__index = function(L_1265_arg0, L_1266_arg1)
local L_1267_ = L_1169_(L_1252_, L_1266_arg1)
if L_1267_ ~= nil then
return L_1267_
end
local L_1268_ = L_1264_[L_1266_arg1]
if L_1268_ ~= nil then
return L_1268_
end
return L_1251_[L_1266_arg1]
end
})
L_1168_(L_1246_, L_1252_)
L_1247_ = true
end
return L_1248_, L_1249_, L_1250_, L_1254_, L_1255_
end
for L_1269_forvar0, L_1270_forvar1 in L_1159_, L_1178_ do
L_1173_(L_1186_, L_1270_forvar1)
end
do
local L_1271_
for L_1272_forvar0, L_1273_forvar1 in L_1159_, L_1185_ do
if L_1273_forvar1.ClassName == 'ModuleScript' and L_1273_forvar1.Name == 'MainModule' then
L_1271_ = L_1273_forvar1
break
end
end
if L_1271_ then
return L_1186_(L_1271_)
end
end
end